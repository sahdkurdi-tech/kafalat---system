...
// ==========================================
// گۆڕینی ژمارەی کوردی/عەرەبی/فارسی بۆ ئینگلیزی بە شێوەی ئۆتۆماتیکی
// ==========================================
document.addEventListener('input', function(e) {
    // تەنها کار لەسەر خانەکانی نووسین دەکات
    if (e.target.tagName === 'INPUT' || e.target.tagName === 'TEXTAREA') {
        ...
        // تەنها ئەگەر ژمارەیەک گۆڕدرا بێت، بەهاکە نوێ دەکەینەوە
        if (originalValue !== convertedValue) {
            // هەڵگرتنی شوێنی کەرسەر (Cursor) بۆ ئەوەی لەکاتی نووسیندا نەچێتە کۆتایی
            let start = null;
            let end = null;
            ...
            try {
                ...
                // هەندێک جۆری input وەک 'number' پشتگیری selection ناکەن
            }
            
            e.target.value = convertedValue;
            
            // گەڕاندنەوەی کەرسەر بۆ شوێنی خۆی
